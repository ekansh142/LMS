...
const CourseDetail = () => {
    ...
    return (
        <div className='mt-2 space-y-5'>
            <div className='bg-[#514c4e] dark:bg-gray-900 text-white'>
                        ...
                        <CardContent className="space-y-3">
                            {
                                course?.lectures.map((lecture, index) => (
                                    <div key={index} lecture={lecture} className='flex items-center gap-3 text-sm'>
                                        <span>
                                            {
                        ...
                        <CardFooter className="flex justify-center p-4">
                            {
                                ...
                                ) : <BuyCourseButton course={course} courseId={courseId} />
                            }
                        </CardFooter>
                    </Card>
                </div>
