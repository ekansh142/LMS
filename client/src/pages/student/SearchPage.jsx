...
const SearchPage = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto p-4 md:p-8 mt-0'>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white dark:bg-transparent mb-10 gap-4">
                {/* Left: Result text */}
                <div className="flex-1">
                    <h1 className="font-bold text-xl md:text-2xl text-black dark:text-white">Result for "{query}"</h1>
                    <p>
                        Showing results for{" "}
