...
import { useEditLectureMutation, useGetLectureByIdQuery, useGetLectureQuery, useRemoveLectureMutation } from '@/features/api/courseApi'
...
const MEDIA_API = "https://lms-hhw0.onrender.com/api/v1/media";
    ...
    return (
        <Card>
            ...
            <CardContent>
                ...
                <div disabled={isLoading} className='mt-8'>
